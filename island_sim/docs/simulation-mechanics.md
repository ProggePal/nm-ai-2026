...
Each of the 50 years cycles through 5 phases in order:

1. **Growth** — Settlements produce food, grow population, expand
2. **Conflict** — Raids, looting, cultural assimilation
3. **Trade** — Ports exchange wealth, food, technology
4. **Winter** — Food loss, collapses, population dispersal
5. **Environment** — Forests reclaim abandoned ruins
...
- **Defense**
- **Tech level**
- **Port status** (has_port)
- **Longship ownership**
- **Faction allegiance** (owner_id)

**Initial states expose only:** settlement positions and port status.
**Internal stats** (population, food, wealth, defense) are **only visible through simulation queries**.
